  ...
  return (
    <div className="max-w-md mx-auto mt-10 p-6 bg-white dark:bg-[#020617] rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-6">
          <label htmlFor="confirmPassword" className="block text-gray-700 dark:text-slate-300 mb-2">
            Confirm Password
          </label>
          <input
            type="password"
      ...
      <div className="mt-4 text-center">
        <p className="text-gray-600 dark:text-slate-300">
          ...
          <a href="/login" className="text-blue-500 dark:text-indigo-400 hover:underline">
            Login here
          </a>
        </p>
      </div>
